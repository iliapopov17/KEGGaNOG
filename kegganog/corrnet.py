...
def correlation_network(
    ...
    figsize=(12, 6),
    threshold = 0.5,
    node_size=700, node_color='#A3D5FF', node_edgecolors='#03045E', node_linewidths=1.5,
    label_font_size=8, label_font_color='#03045E', label_verticalalignment='center', label_horizontalalignment='center', label_font_weight='bold',
    ...
    edge_widths = [(1.0 + (w - min_weight) / (max_weight - min_weight)) if max_weight > min_weight else 2.0 for w in weights]
